...
class STrack(BaseTrack):
    ...
    def activate(self, kalman_filter, frame_id):
        ...
        self.mean, self.covariance = self.tlwh_to_xyah(self._tlwh), None
        self.tracklet_len = 0
    ...
    def update(self, new_track, frame_id):
        ...
        self.mean = self.tlwh_to_xyah(new_tlwh)
        self.covariance = None
        self.state = TrackState.Tracked
        self.is_activated = True
        self.last_det_idx = new_track.last_det_idx
...
class BYTETracker(object):
    ...
    def update(self, output_results, img_info=None, img_size=None):
        ...
        matches_second, u_track, u_detection_second = matching.linear_assignment(
            dists, thresh=0.5)
        ...
        if not self.args.mot20:
            dists = matching.fuse_score(dists, detections)
        matches_unconfirmed, u_unconfirmed, u_detection = matching.linear_assignment(
            dists, thresh=0.7)
